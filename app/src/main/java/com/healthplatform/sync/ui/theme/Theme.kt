...
private val ApexDarkColorScheme = darkColorScheme(
    ...
    primaryContainer = ApexSurfaceVariant,
    onPrimaryContainer = ApexOnBackground,
    secondary = ApexSecondary,
    onSecondary = ApexOnSecondary,
    secondaryContainer = ApexSurface,
    onSecondaryContainer = ApexOnBackground,
    tertiary = ApexSecondary,
    onTertiary = ApexOnSecondary,
    error = ApexError,
    onError = ApexOnError,
